...
var Collider2D = /** @class */ (function (_super) {
  ...
  function Collider2D(body) {
    ...
    _this.onColliding = function (body, contact) {
      return _this.emit(
        BodyEvent_1.BodyEvent.COLLIDING,
    ...
    _this.onCollideStart = function (body, contact) {
      return _this.emit(
        BodyEvent_1.BodyEvent.COLLIDE_START,
        body.getUserData().unwrap().getRequiredComponent(Collider2D),
        contact
      );
    };
    _this.onCollideEnd = function (body, contact) {
      return _this.emit(
        BodyEvent_1.BodyEvent.COLLIDE_END,
        body.getUserData().unwrap().getRequiredComponent(Collider2D),
        contact
      );
    };
  ...
  Collider2D.prototype.onAdd = function () {
    ...
    engine_1.TransformComponent.getTransform(this.getRequiredEntity()).ifSome(
      function (transform) {
  ...
  Collider2D.prototype.onUpdate = function () {
    ...
    engine_1.TransformComponent.getTransform(this.getRequiredEntity()).ifSome(
      function (transform) {
        switch (_this.body.getType()) {
          case BodyType_1.BodyType.Kinematic:
          case BodyType_1.BodyType.Static:
            transform.getLocalPosition2(_this.body.getPosition());
            _this.body.setRotation(transform.getLocalRotationZ());
            break;
          default:
            transform.setLocalPosition2(_this.body.getPosition());
            transform.setLocalRotationZ(_this.body.getRotation());
            break;
        }
      }
    );
